...
export const subscriptionRouter = createTRPCRouter({
  create: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      if (input.frequency === 'DAILY') nextOrder.setDate(nextOrder.getDate() + 1);
      else if (input.frequency === 'WEEKLY') nextOrder.setDate(nextOrder.getDate() + 7);
      else if (input.frequency === 'MONTHLY') nextOrder.setMonth(nextOrder.getMonth() + 1);
