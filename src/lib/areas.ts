...
export const THIRUVOTTRIYUR_LOCALITIES: AreaOption[] = [
  {
    label: "Thiruvottriyur Town",
    value: "Thiruvottriyur Town",
    locality: "Thiruvottriyur",
    pincode: "600019",
    isServiceable: true,
  },
  {
  ...
  {
    label: "Mel Thiruvottriyur",
    value: "Mel Thiruvottriyur",
    locality: "Thiruvottriyur",
    pincode: "600019",
    isServiceable: true,
  },
  {
    label: "Ponneri High Road",
    value: "Ponneri High Road",
    locality: "Thiruvottriyur",
    pincode: "600019",
    isServiceable: true,
  },
  ...
  {
    label: "Arunachalam Nagar",
    value: "Arunachalam Nagar",
    locality: "Thiruvottriyur",
    pincode: "600019",
    isServiceable: true,
  },
  ...
  {
    label: "Anna Nagar (North Chennai)",
    value: "Anna Nagar North Chennai",
    locality: "Thiruvottriyur",
    pincode: "600019",
    isServiceable: true,
  },
...
export const SERVICEABLE_VALUES = THIRUVOTTRIYUR_LOCALITIES.map((a) =>
  a.value.toLowerCase(),
);
...
export function isAreaServiceable(area: string | null | undefined): boolean {
  ...
  return SERVICEABLE_VALUES.some(
