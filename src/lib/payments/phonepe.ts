...
const API_URL = process.env.PHONEPE_API_URL || 'https://api-preprod.phonepe.com/apis/pg-sandbox/pg/v1/pay';

export async function initiatePhonePePayment(req: PaymentInitiateRequest): Promise<PaymentInitiateResponse> {
  const payload = {
