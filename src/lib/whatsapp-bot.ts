      ...
      interactive: {
        ...
        action: {
          buttons: [
            {
              type: "reply",
              reply: { id: "btn_browse", title: "🛍️ Browse Menu" },
            },
            {
              type: "reply",
      ...
      interactive: {
        ...
        action: {
          buttons: [
            {
              type: "reply",
              reply: { id: `view_${order.id}`, title: "📍 Live Tracking" },
            },
            {
              type: "reply",
              reply: { id: "btn_menu", title: "🏠 Back to Menu" },
            },
          ],
        },
      },
      ...
      interactive: {
        ...
        action: {
          buttons: [
            {
              type: "reply",
              reply: { id: `view_map_${orderId}`, title: "📍 Track Driver" },
            },
          ],
        },
      },
