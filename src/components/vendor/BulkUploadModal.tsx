    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
      ...
      <div className="bg-white w-full max-w-xl rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="px-6 py-5 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
          ...
          <button
            onClick={onClose}
            className="w-10 h-10 bg-white border border-gray-100 rounded-2xl flex items-center justify-center text-gray-400 hover:text-gray-600 transition-colors"
          >
            {" "}
            <X size={20} />{" "}
          </button>{" "}
        ...
        <div className="p-6 overflow-y-auto space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-2xl p-4 flex items-start gap-3">
                ...
                <div className="text-xs text-blue-700 space-y-1">
                  ...
                  <p>
                    • Ensure Category names match existing categories in
                    Deeshora.
                  </p>{" "}
          ...
          {/* Upload Area */}{" "}
          <div
            className={`relative border-2 border-dashed rounded-3xl p-10 transition-all text-center ${file ? "border-emerald-200 bg-emerald-50/30" : "border-gray-200 hover:border-brand-300 bg-gray-50/50"}`}
          >
            {" "}
            <input
              type="file"
            ...
            <div className="flex flex-col items-center">
              ...
              {file ? (
                ...
                <>
                  {" "}
                  <div className="w-14 h-14 bg-white shadow-sm border border-gray-100 rounded-2xl flex items-center justify-center text-brand-500 mb-4">
                    {" "}
                    <Upload size={28} />{" "}
                  </div>{" "}
            ...
            <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100 animate-in slide-in-from-bottom-2">
              ...
              <div className="max-h-40 overflow-y-auto space-y-2">
                ...
                {parsedData.slice(0, 5).map((item, idx) => (
                  <div
                    key={idx}
                    className="flex items-center justify-between bg-white px-3 py-2 rounded-xl border border-gray-50 text-[11px]"
                  >
                    {" "}
        ...
        <div className="p-6 border-t border-gray-100 flex gap-3">
          ...
          <button
            ...
            disabled={
              !file || parsedData.length === 0 || uploadMutation.isPending
            }
            className="flex-[2] h-12 rounded-2xl bg-brand-500 text-white text-sm font-black hover:bg-brand-600 transition-all shadow-lg shadow-brand-500/20 disabled:opacity-50 flex items-center justify-center gap-2"
          >
            {" "}
