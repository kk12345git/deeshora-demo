        ...
        <div className="absolute top-full left-0 mt-2 w-64 bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden z-50 animate-in fade-in slide-in-from-top-2 duration-200">
          ...
          <div className="max-h-64 overflow-y-auto">
            ...
            <button
              ...
              className="w-full flex items-center justify-between px-4 py-3 text-sm hover:bg-brand-50 transition-colors text-gray-700"
            >
              {" "}
              <span>All Areas</span>{" "}
              {!currentCity && (
            ...
            {isLoading ? (
              ...
              cities?.map((city) => (
                <button
                  ...
                  className="w-full flex items-center justify-between px-4 py-3 text-sm hover:bg-brand-50 transition-colors text-gray-700 font-medium capitalize"
                >
                  {" "}
                  <span>{city}</span>{" "}
                  {currentCity === city && (
