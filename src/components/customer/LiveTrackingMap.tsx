      ...
      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 200">
        ...
        <g>
          ...
          <text
            ...
            y="180"
            textAnchor="middle"
            className="text-[10px] font-black fill-gray-400 dark:fill-gray-600 uppercase tracking-widest"
          >
            Shop
          </text>
        </g>
        ...
        {status === "OUT_FOR_DELIVERY" && (
          ...
          >
            ...
            <circle
              r="16"
              className="stroke-brand-500 fill-none animate-ping opacity-20"
              strokeWidth="4"
            />
          </motion.g>
        )}
