...
export function EditVendorModal({
  ...
  const updateCommissionMutation =
    trpc.admin.updateVendorCommission.useMutation({
      onSuccess: () => {
      ...
      <div className="relative bg-white w-full max-w-2xl rounded-[2.5rem] shadow-2xl overflow-hidden border border-gray-100 animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="bg-gray-900 p-8 text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-400 font-bold text-sm mt-1">
              {formData.shopName} · {vendor.user.email}
            </p>
          </div>
        </div>
        ...
        >
          <div className="grid sm:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest flex items-center gap-2">
                <IndianRupee size={12} className="text-brand-500" /> Platform
                Commission (%)
              </label>
              <input
                type="number"
            ...
            <div className="col-span-full space-y-2">
              <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest flex items-center gap-2">
                <Globe size={12} className="text-blue-500" /> Merchant UPI ID
                (for direct payments)
              </label>
              <input
                type="text"
