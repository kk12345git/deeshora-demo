            ...
            <form onSubmit={handleSearchSubmit} className="relative group">
              <div className="flex items-center bg-white/5 border border-white/10 rounded-[1.75rem] overflow-hidden focus-within:border-brand-500/50 focus-within:bg-white/8 transition-all">
                ...
                {liveQuery !== query && liveQuery.trim() && (
                  <button
                    type="submit"
                    className="m-1.5 flex items-center gap-2 bg-brand-500 hover:bg-brand-600 text-white font-black px-5 py-3 rounded-[1.25rem] transition-all text-sm"
                  >
              ...
              <div className="flex flex-wrap items-center justify-center gap-2">
                {['Tomato', 'Milk', 'Rice', 'Chicken', 'Bread', 'Eggs', 'Paneer'].map((term) => (
                  <Link
                    ...
                    className="px-4 py-2 bg-gray-50 border border-gray-200 rounded-full text-sm font-bold text-gray-600 hover:border-brand-300 hover:text-brand-600 hover:bg-brand-50 transition-all"
                  >
                    {term}
                  </Link>
                ))}
