...
export default function OrderPaymentPage() {
  ...
  const upiUrl = `upi://pay?pa=${adminUpiId}&pn=${encodeURIComponent("Deeshora")}&am=${order.total.toFixed(2)}&tr=${order.id}&cu=INR`;
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 font-medium text-sm mt-2">
            Pay directly to{" "}
            <span className="text-gray-900 font-bold">Deeshora</span>
          </p>
        </div>
        ...
        <div className="bg-white rounded-[2rem] border border-gray-100 shadow-sm p-6 mb-6">
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            ...
            >
              <QrCode
                size={32}
                className={showQR ? "text-emerald-500" : "text-gray-400"}
              />
              Scan QR Code
            </button>
          </div>
          ...
          {!showQR ? (
            <div className="text-center space-y-4 animate-in fade-in zoom-in-95">
              ...
              <p className="text-xs font-bold text-gray-400">
                Clicking above will open GPay, PhonePe, Paytm etc.
              </p>
            </div>
          ) : (
            <div className="text-center animate-in fade-in zoom-in-95">
              ...
              <p className="text-xs font-bold text-gray-400 mt-4">
                Scan this code using any UPI app to pay <br />
                <span className="text-gray-900 font-black">Deeshora</span>
              </p>
            </div>
          )}
        </div>
        ...
        <div className="bg-white rounded-[2rem] border border-gray-100 shadow-sm p-6">
          ...
          <p className="text-xs font-bold text-gray-400 mb-4 leading-relaxed">
            After paying, enter the 12-digit UTR / Transaction ID from your app
        ...
        <p className="text-center text-[10px] font-bold text-gray-400 uppercase tracking-widest flex items-center justify-center gap-1.5 mt-8">
          ...
          Direct-to-Vendor Secure Payment
        </p>
      </div>
    </div>
  );
