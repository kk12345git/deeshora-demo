...
import { 
  ...
  Navigation, Loader2, ArrowLeft, ChevronRight, AlertCircle 
} from 'lucide-react';
...
export default function MyAddressesPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto py-8 px-4 space-y-8">
      ...
      <div className="space-y-4">
        {isLoading ? (
          <div className="py-12 flex justify-center"><Loader2 className="w-10 h-10 animate-spin text-brand-500" /></div>
        ) : addresses.length === 0 ? (
