        ...
        <div className="relative z-10 space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-brand-100 text-sm font-medium">
              When your friend places their first order, we&apos;ll send a ₹50
              coupon straight to your wallet.
            </p>
          </div>
          <div className="bg-white/10 backdrop-blur-md rounded-3xl p-6 flex flex-col items-center gap-4 border border-white/20">
            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-brand-100">
              Your Referral Code
            </p>
...
function Step({
  ...
  return (
    <div className="flex gap-4">
      <div className="text-2xl font-black text-brand-100 leading-none">
        {number}
      </div>
      <div>
