...
import { 
  ...
  TrendingUp, IndianRupee, Sparkles
} from 'lucide-react';
...
export default function ReferralDashboard() {
  ...
  return (
    <div className="max-w-2xl mx-auto py-8 px-4 space-y-8">
      ...
      {/* Hero Card */}
      <div className="bg-gradient-to-br from-orange-500 to-rose-600 rounded-[2.5rem] p-8 text-white relative overflow-hidden shadow-2xl shadow-orange-500/20">
        ...
        <div className="relative z-10 space-y-6">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-3xl p-6 flex flex-col items-center gap-4 border border-white/20">
            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-orange-100">Your Referral Code</p>
            <div className="flex items-center gap-3 w-full">
               ...
               <button 
                ...
                className="w-14 h-14 bg-orange-400 hover:bg-orange-300 rounded-2xl flex items-center justify-center transition-colors shadow-lg"
               >
            ...
            <button 
              onClick={shareLink}
              className="w-full py-4 bg-white text-orange-600 rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-orange-50 transition-all flex items-center justify-center gap-2"
            >
      ...
      <div className="bg-white rounded-[2rem] border border-gray-100 p-8 space-y-6">
        <h3 className="font-black text-gray-900 flex items-center gap-2">
          <Sparkles size={18} className="text-orange-500" /> How it works
        </h3>
...
function Step({ number, title, desc }: { number: string; title: string; desc: string }) {
  return (
    <div className="flex gap-4">
      <div className="text-2xl font-black text-orange-100 leading-none">{number}</div>
      <div>
