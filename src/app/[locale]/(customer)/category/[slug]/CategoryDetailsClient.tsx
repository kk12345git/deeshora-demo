          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-white/40 font-bold uppercase tracking-[0.2em] text-sm">
                {" "}
                Expert Curation <span className="mx-2 text-white/10">
                  •
                </span>{" "}
                {selectedCity || "Thiruvottriyur Region"}{" "}
              </p>{" "}
            </div>{" "}
        ...
        {isLoading ? (
          ...
          <div className="text-center py-32 bg-white border-2 border-dashed border-gray-100 rounded-[3rem]">
            ...
            <p className="mt-2 text-gray-500 max-w-sm mx-auto font-medium">
              We don&apos;t have any items in this category for{" "}
              {selectedCity || "your area"} yet. Check back soon!
            </p>{" "}
