    ...
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <section className="bg-white border-b border-gray-100 pt-12 pb-20">
        ...
        <div className="container mx-auto px-4 text-center">
          {" "}
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-50 text-brand-600 text-xs font-black uppercase tracking-widest mb-6">
            {" "}
        ...
        {isLoading ? (
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-500 text-sm line-clamp-2 mb-6">
                    ...
                    {community.description ||
                      "Welcome to our exclusive community! Join us for updates and special offers."}{" "}
                  </p>{" "}
          ...
          <div className="text-center py-24 bg-white border-2 border-dashed border-gray-100 rounded-[3rem]">
            ...
            <p className="mt-2 text-gray-500 max-w-sm mx-auto">
              Communities are being set up by local shops. Check back soon!
            </p>{" "}
          </div>
        )}{" "}
      </div>{" "}
