  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="bg-gray-900/50 border border-gray-800 rounded-[2.5rem] p-8 text-center relative overflow-hidden">
        ...
        <h2 className="text-2xl font-black text-white italic capitalize mb-1">
          {user?.fullName}
        </h2>{" "}
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        {stats.map((stat) => {
          ...
          return (
            <div
              key={stat.label}
              className="bg-gray-900 border border-gray-800 p-4 rounded-3xl text-center"
            >
              {" "}
              <div
                className={`w-10 h-10 rounded-2xl bg-gray-950 flex items-center justify-center mx-auto mb-3 ${stat.color} shadow-inner`}
              >
                {" "}
                <Icon size={20} />{" "}
              </div>{" "}
