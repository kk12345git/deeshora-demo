...
export default function EarningsPage() {
  ...
  const { data: history, isLoading: historyLoading } =
    trpc.delivery.getEarningsHistory.useQuery();
    ...
    <div className="space-y-8 pb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="relative z-10">
          ...
          <div className="flex gap-4">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 flex-1 border border-white/5">
              <span className="text-[10px] font-black uppercase tracking-widest block mb-1 opacity-70">
                This Week
              </span>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between px-2">
          <h3 className="text-sm font-black text-gray-100 uppercase tracking-[0.2em] italic">
            Payout History
          </h3>
            ...
            {history.map((item) => (
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <div className="text-[10px] text-green-500 font-black uppercase tracking-widest">
                    Credited
                  </div>
                </div>
              </Link>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">
              Earnings are credited every Tuesday
            </p>
          </div>
        </div>
        <ArrowRight
