    ...
    return (
      <div className="py-20 flex flex-col items-center justify-center text-center px-6">
        ...
        <p className="text-gray-500 max-w-xs mx-auto">
          All orders are currently claimed or being prepared. Check back in a
          few minutes!
        </p>
        <button
          onClick={() => refetch()}
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between mb-2">
        <div>
          <h2 className="text-2xl font-black text-gray-100 italic">
            Order Pool
          </h2>
          ...
          >
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-xs font-black text-gray-500 uppercase tracking-widest leading-none mb-1">
                    Pickup From
                  </h4>
