      ...
      <div className="grid gap-4">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-[2rem] p-6 space-y-4">
           ...
           <div className="flex items-start gap-3">
              <Package size={18} className="text-brand-500 mt-0.5 flex-shrink-0" />
              <div>
                 <p className="text-sm font-medium text-gray-300">
                    {order.vendor.address}, {order.vendor.city}
                 </p>
                 <a href={`tel:${order.vendor.phone}`} className="text-xs text-brand-500 font-bold mt-2 inline-block">Call Vendor</a>
              </div>
           </div>
        </div>
      </div>
