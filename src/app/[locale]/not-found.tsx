...
export default function NotFound() {
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center px-4 text-center">
      {" "}
      <div className="w-24 h-24 bg-brand-50 text-brand-500 rounded-[2.5rem] flex items-center justify-center mb-8 shadow-xl shadow-brand-500/10">
        {" "}
        <svg
      ...
      <h1 className="text-5xl font-black text-gray-900 tracking-tighter mb-4 italic">
        404
      </h1>{" "}
