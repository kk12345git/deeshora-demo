...
function Input(
  ...
  return (
    ...
    <Component
      {...props}
      className={`w-full h-12 px-4 bg-gray-50 border-2 border-transparent rounded-xl focus:bg-white focus:border-brand-400 outline-none font-bold transition-all ${
        props.className || ""
      }`}
    />
  );
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <Link href="/" className="inline-flex items-center gap-2 mb-6 group">
            <div className="bg-brand-500 text-white font-black text-xl w-10 h-10 flex items-center justify-center rounded-2xl shadow-lg shadow-brand-500/20 group-hover:scale-110 transition-transform">
              D
            </div>
          ...
          <div className="flex flex-col items-center">
            <span className="text-[10px] font-black text-brand-500 uppercase tracking-[0.3em] mb-2 flex items-center gap-2">
            ...
            <p className="text-gray-400 font-bold mt-2 max-w-md mx-auto">
              Join the fastest growing local delivery network in Chennai and
              reach thousands of neighbors.
            </p>
          </div>
        </div>
                ...
                <div className="flex-1 space-y-6 w-full">
                  <div className="grid md:grid-cols-2 gap-6">
                    <FieldGroup label="Shop Name">
                      <Input
                        name="shopName"
                        placeholder="e.g. Thiruvottriyur Fresh"
                        required
                      />
                    </FieldGroup>
                  ...
                  <FieldGroup
                    label="Shop Bio (Search Friendly)"
                    hint="Describe what makes your shop special for your neighbors."
                  >
                    <textarea
                      name="description"
                      rows={3}
                      placeholder="Fresh local produce delivered in 10 minutes..."
                      className="w-full p-4 bg-gray-50 border-2 border-transparent rounded-xl focus:bg-white focus:border-brand-400 outline-none font-bold transition-all resize-none"
                      required
                    />
                  </FieldGroup>
                </div>
            ...
            <div className="p-8 space-y-8">
              ...
              <div className="pt-6 border-t border-gray-50 grid md:grid-cols-2 gap-8">
                <FieldGroup
                  ...
                  hint="For instant settlements and quick payouts."
                >
                  <div className="relative">
                    <Zap
                      size={15}
                    ...
                    <Input
                      name="upiId"
                      className="pl-12 border-brand-100 focus:border-brand-500"
                ...
                <FieldGroup
                  ...
                  hint="Upload your UPI QR code image so customers can pay you directly."
                >
                ...
                <FieldGroup
                  ...
                  hint="Leave blank if not registered for GST."
                >
          ...
          <div className="flex flex-col items-center gap-6 pt-4 pb-12">
            <div className="flex items-start gap-3 max-w-lg text-center">
              ...
              <p className="text-xs text-gray-400 font-bold leading-relaxed">
                By submitting, you agree to the Deeshora Partner Terms and
                authorize our team to review your application for safety and
                quality.
              </p>
            </div>
            <button
              ...
              className="w-full max-w-sm h-16 bg-brand-500 text-white rounded-[2rem] shadow-2xl shadow-brand-500/30 flex items-center justify-center gap-4 font-black uppercase tracking-[0.2em] text-sm hover:bg-brand-600 hover:scale-105 active:scale-95 transition-all disabled:opacity-50 disabled:hover:scale-100"
            >
            ...
            <Link
              href="/"
              className="text-xs font-black text-gray-300 uppercase tracking-widest hover:text-gray-500 transition-colors"
            >
              Cancel Application
            </Link>
          </div>
