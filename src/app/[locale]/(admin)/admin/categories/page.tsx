              ...
              <>                
                ...
                <td className="px-10 py-6">                   
                   {isEditing === cat.id ? (                      
                      ...
                      <div className="flex flex-col">                         
                         <span className="text-lg font-black text-brand-600 tracking-tighter">{((cat.commissionRate ?? 0) * 100).toFixed(1)}%</span>                         
                ...
                <td className="px-10 py-6 text-right">                  
                  {isEditing === cat.id ? (                    
                    ...
                    <div className="flex justify-end gap-3">                      
                      <button onClick={() => handleEdit(cat)} className="w-12 h-12 text-gray-300 hover:text-brand-600 hover:bg-brand-50 rounded-2xl flex items-center justify-center transition-all group-hover:bg-white active:scale-90">                        
                        <Edit size={20} />                      
                      </button>                      
