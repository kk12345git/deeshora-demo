      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-4">
        <div className="xl:col-span-6 relative group">
          ...
          <input
            ...
            className="w-full h-16 pl-14 pr-6 bg-white border border-gray-100 rounded-[1.5rem] shadow-sm focus:ring-4 focus:ring-orange-500/5 focus:border-orange-400 outline-none transition-all font-bold text-sm"
            value={search}
        ...
        <div className="xl:col-span-3 relative">
          ...
          <select
            className="w-full h-16 pl-14 pr-6 bg-white border border-gray-100 rounded-[1.5rem] shadow-sm focus:outline-none focus:ring-4 focus:ring-orange-500/5 focus:border-orange-400 font-black text-[11px] uppercase tracking-wider appearance-none cursor-pointer"
            value={vendorId || ""}
          ...
          {data?.products.map((product, i) => {
            ...
            return (
              <motion.div 
                ...
                className="group bg-white rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-2xl hover:shadow-gray-200/50 hover:border-orange-100 transition-all duration-500 overflow-hidden"
              >
                <div className="flex flex-col xl:flex-row xl:items-center gap-8 p-6">
                  ...
                  <div className="flex items-center gap-6 xl:w-1/3 min-w-0">
                    <div className="relative flex-shrink-0">
                      ...
                      <div className="absolute -top-2 -right-2 w-10 h-10 bg-white border border-gray-50 rounded-xl shadow-lg flex items-center justify-center text-orange-500">
                         <Tag size={16} />
                      </div>
                    </div>
                    <div className="min-w-0 flex-1">
                       <div className="flex items-center gap-2 mb-1.5">
                          <span className="px-2 py-0.5 bg-orange-50 text-orange-600 text-[9px] font-black rounded-md uppercase tracking-widest">{product.category.name}</span>
                       ...
                       <div className="flex items-center gap-2 mt-2 text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                          <MapPin size={12} className="text-orange-500/50" /> {product.vendor.city}
                       </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-8 flex-1 py-6 xl:py-0 border-y xl:border-y-0 xl:border-x border-gray-50 xl:px-8">
                    ...
                    <div>
                       <p className="text-base font-black text-orange-600 tracking-tight leading-none">{currentComm.toFixed(1)}%</p>
                       <p className="text-[10px] font-black text-gray-400 mt-1.5 uppercase tracking-widest truncate">{commSource} Rate</p>
                    </div>
                    <div className="col-span-2">
                       <div className="flex items-center justify-between mb-2">
                          <p className={`text-[10px] font-black uppercase tracking-widest ${product.stock > 10 ? 'text-emerald-600' : 'text-orange-600'}`}>
                       ...
                       <div className="w-full h-2 bg-gray-50 rounded-full overflow-hidden shadow-inner">
                          <motion.div
                            ...
                            className={`h-full rounded-full ${product.stock > 10 ? 'bg-gradient-to-r from-emerald-500 to-emerald-400' : 'bg-gradient-to-r from-orange-500 to-orange-400'}`}
                          />
                       </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 xl:w-48 justify-end">
                    <Link 
                      ...
                      className="flex-1 h-12 flex items-center justify-center gap-2 bg-gray-50 text-gray-900 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-orange-50 hover:text-orange-600 transition-all active:scale-95"
                    >
                      <Edit size={14} /> Edit
                    </Link>
                    <button 
