      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            <span className="px-2 py-0.5 bg-orange-100 text-orange-600 text-[9px] font-black uppercase tracking-widest rounded-md animate-pulse">Real-Time</span>
        ...
        <div className="flex items-center gap-2 bg-white p-2 rounded-2xl border border-gray-100 shadow-sm">
           ...
           <button className="flex items-center gap-2 px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white text-xs font-black uppercase tracking-widest rounded-xl transition-all shadow-lg shadow-orange-500/20 active:scale-95">
          ...
          {activities.length === 0 ? (
            ...
            activities.map((log) => (
              <div key={log.id} className="flex gap-6 group">
                ...
                {/* Content Column */}
                <div className="flex-1 bg-white p-6 rounded-[2rem] border border-gray-100 shadow-sm group-hover:shadow-xl group-hover:shadow-gray-200/40 transition-all border-l-4 group-hover:border-l-orange-500">
                  <div className="flex items-start justify-between gap-4">
                    <div className="space-y-1">
                      ...
                      {log.actorName && (
                        <p className="text-gray-500 text-sm font-medium flex items-center gap-2 mt-1">
                          Performed by <span className="text-orange-600 font-bold">{log.actorName}</span>
                        </p>
                      )}
                    </div>
                    ...
                    <div className="hidden md:block">
                       <Link 
                        ...
                        className="w-10 h-10 rounded-xl bg-gray-50 text-gray-400 flex items-center justify-center hover:bg-orange-500 hover:text-white transition-all active:scale-95"
                       >
                         <ArrowRight size={18} />
                       </Link>
                    </div>
