      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-1">
          ...
          <p className="text-gray-500 text-sm font-medium">
            Watch and audit everything happening across the platform.
          </p>
        </div>
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="space-y-1">
                      <div className="flex items-center gap-3">
                        <span
                          className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border ${getBadgeColor(log.action)}`}
                        >
                    ...
                    Object.keys(log.metadata as object).length > 0 && (
                      <div className="mt-4 pt-4 border-t border-gray-50">
                        <div className="flex flex-wrap gap-2">
                          {Object.entries(log.metadata as object).map(
                            ([k, v]) => (
                              <div
                                key={k}
                                className="px-3 py-1 bg-gray-50 rounded-lg border border-gray-100"
                              >
