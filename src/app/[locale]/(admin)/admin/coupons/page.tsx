    ...
    <div className="space-y-10">
        ...
        <div>
          ...
          <p className="text-gray-500 text-sm font-medium mt-1">
            ...
            <span className="text-gray-900 font-bold">
              {activeCoupons.length} active campaigns
            </span>{" "}
            to drive customer conversion.
          </p>
        </div>
      ...
      {showForm && (
        <motion.div
          ...
          className="bg-white rounded-[3rem] border-2 border-brand-500/20 shadow-2xl p-10 space-y-8 relative overflow-hidden"
        >
          ...
          <form onSubmit={handleCreate} className="space-y-8 relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <FormField label="Campaign Identifier">
                <input
                  ...
                  className="w-full h-16 px-6 bg-gray-50 border-2 border-gray-50 rounded-2xl font-mono text-sm font-black tracking-widest outline-none focus:border-brand-400 focus:bg-white transition-all uppercase"
                  required
                />
              </FormField>
              ...
              <FormField label="Yield Value">
                <div className="relative group">
                  <div className="absolute left-5 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-brand-500 transition-colors">
                    {form.type === "FIXED" ? (
                      <IndianRupee size={16} />
                    ) : (
                      <Percent size={16} />
                  ...
                  <input
                    ...
                    placeholder="0.00"
                    className="w-full h-16 pl-12 pr-6 bg-gray-50 border-2 border-gray-50 rounded-2xl font-black text-lg outline-none focus:border-brand-400 focus:bg-white transition-all"
                    required
                  />
                </div>
              </FormField>
              ...
              <FormField label="Min. Activation Threshold">
                <div className="relative group">
                  ...
                  <input
                    ...
                    placeholder="None"
                    className="w-full h-16 pl-12 pr-6 bg-gray-50 border-2 border-gray-50 rounded-2xl font-black text-sm outline-none focus:border-brand-400 focus:bg-white transition-all"
                  />
                </div>
              </FormField>
              ...
              <FormField label="System Expiration">
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full h-16 pl-12 pr-6 bg-gray-50 border-2 border-gray-50 rounded-2xl font-black text-[10px] uppercase tracking-widest outline-none focus:border-brand-400 focus:bg-white transition-all appearance-none"
                  />
                </div>
              </FormField>
            </div>
            ...
            <div className="flex gap-4 pt-4">
              <button
                ...
                className="h-16 flex-1 bg-gray-950 text-white rounded-2xl font-black text-xs uppercase tracking-[0.2em] flex items-center justify-center gap-3 transition-all shadow-2xl shadow-gray-950/20 hover:bg-brand-600 disabled:opacity-20 active:scale-95"
              >
        ...
        {isLoading ? (
          ...
          <div className="bg-white rounded-[3rem] border border-gray-100 p-16 text-center shadow-sm">
            ...
            <p className="text-gray-400 text-sm mt-3 font-medium">
              Initiate your first promo code to accelerate platform growth.
            </p>
          </div>
        ) : (
          <div className="grid grid-cols-1 gap-4">
            {coupons.map((coupon, i) => {
              const isExpiredByDate = coupon.expiresAt
              ...
              return (
                ...
                >
                  {/* Status Visual */}
                  <div
                    className={`w-16 h-16 rounded-[1.5rem] flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-500 ${
                      coupon.type === "FIXED"
                        ? "bg-blue-50 text-blue-500"
                        : "bg-purple-50 text-purple-500"
                    }`}
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-3 mb-2 flex-wrap">
                      <span className="font-mono font-black text-gray-950 text-lg tracking-widest uppercase">
                        {coupon.code}
                      </span>
                      <div className="flex gap-2">
                        {!coupon.isActive && (
                          <span className="text-[9px] font-black uppercase tracking-widest text-gray-400 bg-gray-50 px-2.5 py-1 rounded-lg">
                            Suspended
                          </span>
                        )}
                        {isExpiredByDate && (
                          <span className="text-[9px] font-black uppercase tracking-widest text-red-500 bg-red-50 px-2.5 py-1 rounded-lg border border-red-100">
                            Expired
                          </span>
                        )}
                        {isMaxed && (
                    ...
                    <div className="flex items-center gap-5 flex-wrap">
                      <div className="flex flex-col">
                        <span className="text-sm font-black text-brand-600 tracking-tight leading-none">
                          {coupon.type === "FIXED"
                            ? `₹${coupon.value.toLocaleString()} Instant`
                            : `${coupon.value}% Yield`}
                        </span>
                  ...
                  <div className="md:w-48">
                    ...
                    <div className="h-2 bg-gray-50 rounded-full overflow-hidden shadow-inner">
                      <motion.div
                        ...
                        className={`h-full rounded-full ${usagePct !== null && usagePct >= 90 ? "bg-red-500" : "bg-brand-500"}`}
                      />
                    </div>
                  </div>
                    ...
                    {deleteConfirm === coupon.id ? (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="w-12 h-12 flex items-center justify-center text-gray-400 hover:text-gray-900"
                        >
                          <X size={18} />
                        </button>
                      </motion.div>
