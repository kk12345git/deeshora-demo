      ...
      {isPlatformLoading ? (        
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">          
          ...
          <StatCard            
            ...
            icon={<Users size={22} />}            
            colorBg="bg-brand-500" colorText="text-white"          
          />        
        </div>      
      )}      
              ...
              {platformData?.topVendors.map((v: any, i: number) => (                
                ...
                >                  
                  <div className={`w-8 h-8 rounded-xl font-black text-xs flex items-center justify-center flex-shrink-0 shadow-lg ${                    
                    i === 0 ? 'bg-gradient-to-br from-amber-400 to-brand-500 text-white' :                     
                    i === 1 ? 'bg-gradient-to-br from-gray-300 to-gray-500 text-white' :                     
                    i === 2 ? 'bg-gradient-to-br from-brand-800 to-red-950 text-white' : 'bg-white/10 text-gray-400'                  
                  }`}>                    
                    {i + 1}                  
                  </div>                  
