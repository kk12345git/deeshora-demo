      ...
      <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-6">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4">
          ...
          <div className="relative w-full sm:w-80 group">
            <Search size={16} className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-brand-500 transition-colors" />
            <input
              value={search}
            ...
            return (
              <motion.div 
                ...
                className={`group bg-white rounded-[2rem] border transition-all duration-300 overflow-hidden ${
                  isExpanded ? 'border-brand-200 ring-4 ring-brand-500/5 shadow-2xl shadow-brand-500/10' : 'border-gray-100 shadow-sm hover:shadow-xl hover:shadow-gray-200/50 hover:border-gray-200'
                }`}
              >
                {/* Primary Row */}
                <button
                ...
                >
                  {isExpanded && <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-brand-500" />}
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-3 text-xs font-medium text-gray-400">
                      <span className="flex items-center gap-1.5"><MapPin size={12} className="text-brand-500/60" /> {vendor.city}</span>
                  ...
                  <div className="hidden lg:flex items-center gap-8 px-8 border-x border-gray-50">
                    ...
                    <div className="text-right min-w-[100px]">
                      <p className="font-black text-brand-600 text-base">₹{vendor.pendingPayout.toLocaleString('en-IN')}</p>
                      <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest">Pending Payout</p>
                    </div>
                  </div>

                  {/* Interaction */}
                  <div className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all ${isExpanded ? 'bg-brand-500 text-white shadow-lg shadow-brand-500/20' : 'bg-gray-50 text-gray-300 group-hover:text-gray-600 group-hover:bg-gray-100'}`}>
