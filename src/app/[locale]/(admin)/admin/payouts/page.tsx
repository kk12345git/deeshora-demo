    ...
    <div className="space-y-6">      
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">        
        ...
        >          
          ...
          <p className="text-[10px] font-black uppercase tracking-widest text-brand-600 mt-1">Pending Liquidity</p>          
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">        
        ...
        <div className="xl:col-span-4 space-y-6">          
          <div className="flex items-center justify-between">             
            ...
            <span className="px-2 py-0.5 bg-brand-50 text-brand-600 text-[9px] font-black rounded-md uppercase tracking-widest">{pendingVendors.length} Action Items</span>          
          </div>          
              ...
              {pendingVendors.map((v, i) => (                
                ...
                >                  
                  <div className={`w-12 h-12 rounded-2xl flex items-center justify-center font-black text-sm transition-colors ${                    
                    selectedVendorId === v.id ? 'bg-brand-500 text-white' : 'bg-gray-50 text-gray-400'                  
                  }`}>                    
                    {v.shopName.charAt(0)}                  
                  </div>                  
                  ...
                  <div className="text-right">                    
                    ...
                    <p className="text-[9px] font-black text-brand-500 uppercase tracking-widest mt-0.5">Due Now</p>                  
                  </div>                
                </motion.button>              
              ))}            
            </div>          
          ...
          >            
            ...
            <form onSubmit={handleSubmit} className="p-10 space-y-8">              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">                
                ...
                <div className="space-y-2.5">                  
                  ...
                  <div className="relative group">                    
                    <Store size={18} className="absolute left-5 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-brand-500 transition-colors" />                    
                    <select                      
                ...
                <div className="space-y-2.5">                  
                  ...
                  <div className="relative group">                    
                    <IndianRupee size={18} className="absolute left-5 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-brand-500 transition-colors" />                    
                    <input                      
                      type="number"                      
                      step="0.01"                      
                      min={0.01}                      
              ...
              <div className="space-y-2.5">                
                ...
                <div className="relative group">                  
                  <Hash size={18} className="absolute left-5 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-brand-500 transition-colors" />                  
                  <input                    
                    type="text"                    
                    value={utrNumber}                    
