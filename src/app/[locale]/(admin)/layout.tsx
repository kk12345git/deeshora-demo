...
import { 
  LayoutDashboard, Users, Store, ShoppingCart, CreditCard, Settings, Loader2, Menu, X, 
  Package, MapPin, Tag, BarChart2, FileText, Clock 
} from "lucide-react";
              ...
              <nav className="p-6 overflow-y-auto flex-grow space-y-1.5">
                {navItems.map((item) => {
                  ...
                  return (
                    ...
                    >
                      {isActive && (
                        <motion.div layoutId="nav-pill-mobile" className="absolute inset-0 bg-brand-600 rounded-2xl shadow-lg shadow-brand-600/20" />
                      )}
        ...
        <div className="p-8 border-b border-white/5">
          <Link href="/admin" className="flex items-center gap-3 group">
            ...
            <div className="flex flex-col -space-y-1">
                ...
                <span className="text-[10px] font-black text-brand-500 uppercase tracking-[0.25em] mt-1">Admin Panel</span>
            </div>
          </Link>
        </div>
