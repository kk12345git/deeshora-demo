  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div>
          {" "}
          <p className="text-xs font-black text-brand-500 uppercase tracking-widest flex items-center gap-1.5">
            {" "}
          ...
          <p className="text-sm text-gray-400 mt-1">
            Generate and print invoices for your paid sales
          </p>{" "}
        </div>{" "}
        <div className="relative">
          ...
          <input
            ...
            className="w-full md:w-80 h-12 pl-12 pr-4 bg-white border border-gray-200 rounded-2xl shadow-sm focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 transition-all font-bold"
          />{" "}
        </div>{" "}
      </div>{" "}
      {isLoading ? (
        ...
        <div className="bg-white rounded-3xl border border-dashed border-gray-200 py-24 text-center">
          ...
          <p className="text-gray-400 mt-2">
            Paid orders will appear here for invoice generation.
          </p>{" "}
        </div>
      ) : (
        <div className="grid gap-4">
          ...
          {filteredOrders?.map((order) => {
            ...
            return (
              <div
                key={order.id}
                className="group bg-white rounded-2xl border border-gray-100 shadow-sm hover:border-brand-500/30 hover:shadow-xl hover:shadow-brand-500/5 transition-all overflow-hidden"
              >
                {" "}
                <div className="p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-black text-gray-900 group-hover:text-brand-500 transition-colors uppercase">
                        #{order.id.slice(-8)}
                      </p>{" "}
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Link
                        ...
                        className="flex items-center gap-2 bg-gray-950 text-white px-5 py-3 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-brand-600 transition-all shadow-lg shadow-gray-950/20 active:scale-95"
                      >
                        {" "}
