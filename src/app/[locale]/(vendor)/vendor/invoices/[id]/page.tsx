...
export default function VendorInvoicePrintPage() {
  ...
  const { data: order, isLoading } = trpc.order.vendorOrderById.useQuery({
    id,
  });
  if (isLoading) {
    return (
    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-24">
      ...
      <div className="flex items-center justify-between no-print bg-gray-900 text-white p-4 rounded-2xl shadow-xl">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={handlePrint}
            className="flex items-center gap-2 bg-brand-500 hover:bg-brand-600 text-white px-6 py-2.5 rounded-xl font-black text-xs uppercase tracking-widest transition-all active:scale-95"
          >
            {" "}
      ...
      {/* Invoice Document */}{" "}
      <div
        className="bg-white p-8 md:p-16 rounded-3xl shadow-sm border border-gray-100 print:shadow-none print:border-none print:p-0"
        id="invoice-content"
      >
        {" "}
        {/* Header */}{" "}
        <div className="flex flex-col md:flex-row justify-between gap-8 mb-16">
          ...
          <div className="space-y-4">
            ...
            <div>
              {" "}
              <h1 className="text-3xl font-black text-gray-950 uppercase tracking-tighter leading-none mb-1">
                {vendor.shopName}
              </h1>{" "}
              <p className="text-sm font-bold text-gray-500">
                {vendor.city}, Tamil Nadu
              </p>{" "}
            </div>{" "}
        ...
        <div className="h-px bg-gray-100 mb-12" /> {/* Addresses */}{" "}
          ...
          <table className="w-full text-left border-collapse">
            ...
            <thead>
              ...
              <tr className="border-b-2 border-gray-900">
                ...
                <th className="py-4 text-[10px] font-black uppercase tracking-widest text-gray-400 text-center">
                  Qty
                </th>{" "}
            ...
            <tbody className="divide-y divide-gray-100">
              ...
              {items.map((item: any) => (
                <tr key={item.id}>
                  ...
                  <td className="py-6 text-center text-sm font-black text-gray-800">
                    {item.quantity}
                  </td>{" "}
                  <td className="py-6 text-right text-sm font-black text-gray-800">
                    ₹{item.price.toLocaleString("en-IN")}
                  </td>{" "}
                  {vendor.gstNumber && (
                    <td className="py-6 text-right text-sm font-bold text-gray-500">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-12">
          ...
          <div className="max-w-xs space-y-4">
            ...
            <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100">
              ...
              <p className="text-[10px] font-black text-emerald-600 uppercase mt-2">
                Payout: ₹{order.vendorAmount.toLocaleString("en-IN")}
              </p>{" "}
            </div>{" "}
          </div>{" "}
          <div className="w-full md:w-80 space-y-3">
            ...
            <div className="flex justify-between items-center">
              {" "}
              <span className="font-black text-gray-950 uppercase tracking-widest text-xs">
                Grand Total
              </span>{" "}
        ...
        <div className="mt-20 pt-8 border-t border-gray-100 text-center">
          ...
          <p className="text-sm font-black text-gray-900 mb-1">
            Thank you for shopping with {vendor.shopName}!
          </p>{" "}
          ...
          <div className="mt-8 flex items-center justify-center gap-6">
            ...
            <div className="flex items-center gap-2">
              {" "}
              <div className="w-5 h-5 bg-brand-500 rounded flex items-center justify-center text-[10px] text-white font-black">
                D
              </div>{" "}
