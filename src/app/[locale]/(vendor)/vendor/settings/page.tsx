...
function Input(props: React.InputHTMLAttributes<HTMLInputElement>) {
  return (
    <input
      {...props}
      className={`w-full h-12 px-4 bg-gray-50 border-2 border-transparent rounded-xl focus:bg-white focus:border-brand-400 outline-none font-bold transition-all ${props.className || ""}`}
    />
  );
}
export default function VendorSettingsPage() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Capture all non-file fields, even if empty (to allow clearing)    formData.forEach((value, key) => {      if (typeof value === 'string') {        rawData[key] = value;      }    });
    const payload = {
      ...rawData,
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 space-y-10">
      ...
      <div className="flex items-end justify-between">
        ...
        <div>
          {" "}
          <p className="text-xs font-black text-brand-500 uppercase tracking-widest flex items-center gap-2">
            {" "}
            <Sparkles size={12} /> Partner Experience{" "}
          </p>{" "}
          <h1 className="text-4xl font-black text-gray-950 uppercase tracking-tighter mt-1">
            Vendor Studio
          </h1>{" "}
          <p className="text-sm text-gray-400 mt-1 font-medium">
            Design your shop&apos;s digital identity and manage operations.
          </p>{" "}
        </div>{" "}
        <div className="flex gap-3">
          {" "}
          <span
            className={`inline-flex items-center gap-1.5 text-[10px] font-black px-3 py-1.5 rounded-full ${hasBank ? "bg-emerald-100 text-emerald-700" : "bg-amber-100 text-amber-700"}`}
          >
            {" "}
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 font-bold">
                  Customize how customers see your shop
                </p>{" "}
              </div>{" "}
            </div>{" "}
          </div>{" "}
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="flex-1 space-y-5">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <FieldGroup
                    label="Display Name"
                    hint="This name will appear on the storefront"
                  >
                    {" "}
                    <Input
                      name="shopName"
                  ...
                  <FieldGroup label="Business Category">
                    ...
                    <select
                      ...
                      className="w-full h-12 px-4 bg-gray-50 border-2 border-transparent rounded-xl focus:bg-white focus:border-brand-400 outline-none font-bold transition-all appearance-none cursor-pointer"
                    >
                      {" "}
                ...
                <FieldGroup
                  ...
                  hint="Keep it cheerful and welcoming"
                >
                  {" "}
                  <Input
                    name="description"
                    defaultValue={profile?.description || ""}
                    placeholder="Fresh. Local. Fast."
                  />{" "}
                </FieldGroup>{" "}
              </div>{" "}
            </div>{" "}
        ...
        <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-xl shadow-gray-200/20 p-8">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 font-bold">
                Configure your physical presence
              </p>{" "}
            </div>{" "}
          </div>{" "}
          <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-xl shadow-gray-200/20 p-8">
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 font-bold">
                  Manage where you receive earnings
                </p>{" "}
              </div>{" "}
            </div>{" "}
            <div className="space-y-6">
              ...
              <div className="pt-6 border-t border-gray-50">
                {" "}
                <FieldGroup
                  label="UPI ID for Instant Settlement"
                  hint="Required for lightning-fast payouts"
                >
                  {" "}
                  <div className="relative">
                    {" "}
                    ...
                    <Input
                      ...
                      className="pl-12 border-brand-50 focus:border-brand-500"
          ...
          <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-xl shadow-gray-200/20 p-8 flex flex-col">
            ...
            <div className="flex-1 space-y-6">
              ...
              <FieldGroup
                label="GSTIN Number"
                hint="Professional identity for business customers"
              >
                {" "}
                <Input
                  name="gstNumber"
              ...
              <div className="mt-auto bg-gray-50 rounded-2xl p-6 border border-gray-100">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-[10px] text-gray-500 font-bold leading-relaxed uppercase">
                    {" "}
                    Your financial data is encrypted and used only for automated
                    settlements. Keep these details updated to ensure no delay
                    in your weekly payouts.{" "}
                  </p>{" "}
                </div>{" "}
              </div>{" "}
            </div>{" "}
        ...
        <div className="flex justify-end pt-4">
          ...
          <button
            ...
            className="btn-primary px-16 h-16 rounded-[2rem] shadow-2xl shadow-brand-500/30 font-black tracking-[0.2em] uppercase flex items-center gap-4 text-sm group"
          >
            {" "}
