          ...
          <div className="text-center mb-10 space-y-2">
            ...
            <div className="relative w-20 h-20 mx-auto mb-6 transition-all hover:scale-105 duration-500">
              ...
              <Image
                ...
                alt="Deeshora Logo"
                fill
                className="object-cover rounded-[1.5rem] shadow-2xl shadow-brand-500/20 border border-white/10"
              />{" "}
            </div>{" "}
            ...
            <p className="text-white/40 font-medium">
              Continue your hyperlocal shopping journey
            </p>{" "}
          </div>{" "}
              ...
              <SignIn
                ...
                appearance={{
                  elements: {
                    ...
                    formFieldInput:
                      "bg-white/5 border-white/10 text-white rounded-xl h-12 focus:ring-2 focus:ring-brand-500/40 transition-all",
                    formButtonPrimary:
                      "bg-gradient-to-r from-brand-500 to-brand-600 hover:from-brand-600 hover:to-brand-700 text-white font-black uppercase tracking-widest h-12 rounded-xl border-none shadow-xl shadow-brand-500/20 active:scale-95 transition-all text-sm",
                    footerActionText: "text-white/40 font-medium",
                    footerActionLink:
                      "text-brand-500 hover:text-brand-400 font-black transition-colors",
                    identityPreviewText: "text-white",
                    identityPreviewEditButtonIcon: "text-white/60",
                    formResendCodeLink: "text-brand-500 font-bold",
