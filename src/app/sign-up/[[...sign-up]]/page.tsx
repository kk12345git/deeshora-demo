...
export default function SignUpPage() {
  return (
    <div className="min-h-screen bg-gray-950 flex flex-col relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 w-1/3 h-full bg-gradient-to-l from-orange-500/10 to-transparent blur-3xl opacity-10" />
      ...
      <div className="flex-grow flex items-center justify-center p-4 relative z-10 pb-20">
        <div className="w-full max-w-[480px] animate-in fade-in slide-in-from-bottom-4 duration-700">
          <div className="text-center mb-10 space-y-2">
            <div className="inline-block bg-emerald-500 text-white font-black text-2xl w-14 h-14 flex items-center justify-center rounded-[1.25rem] shadow-2xl shadow-emerald-500/40 mx-auto mb-6">
              D
            </div>
            <h1 className="text-4xl font-black text-white tracking-tighter uppercase">Join Deeshora</h1>
            <p className="text-white/40 font-medium">Start your local commerce evolution today</p>
          </div>
              ...
              <SignUp 
                appearance={{
                  elements: {
                    ...
                    formFieldInput: "bg-white/5 border-white/10 text-white rounded-xl h-12 focus:ring-2 focus:ring-emerald-500/40 transition-all",
                    formButtonPrimary: "bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white font-black uppercase tracking-widest h-12 rounded-xl border-none shadow-xl shadow-emerald-500/20 active:scale-95 transition-all text-sm",
                    footerActionText: "text-white/40 font-medium",
                    footerActionLink: "text-emerald-500 hover:text-emerald-400 font-black transition-colors",
                    identityPreviewText: "text-white",
                    identityPreviewEditButtonIcon: "text-white/60",
                    formResendCodeLink: "text-emerald-500 font-bold",
