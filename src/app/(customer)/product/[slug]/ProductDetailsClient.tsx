...
import { Star, Minus, Plus, AlertTriangle, CheckCircle, ChevronLeft, ShoppingCart, Share2, Heart, MapPin, Loader2 } from 'lucide-react';
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3 overflow-x-auto pb-2 no-scrollbar">
              {product.images.map((img: string, index: number) => (
                ...
                >
                  <Image src={img} alt={`${product.name} preview-${index}`} width={100} height={100} className="w-full h-full object-cover" />
                </button>
              ))}
            </div>
          </div>
