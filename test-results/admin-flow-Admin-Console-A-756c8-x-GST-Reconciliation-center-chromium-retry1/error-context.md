...
- Name: admin-flow.spec.ts >> Admin Console Automation Suite >> should load Admin Tax & GST Reconciliation center
- Location: tests\e2e\admin-flow.spec.ts:47:7
...
Locator: locator('text=GST').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=GST').first()
