...
- Name: admin-flow.spec.ts >> Admin Console Automation Suite >> should render Category Management settings
- Location: tests\e2e\admin-flow.spec.ts:57:7
...
Locator:  locator('text=Categories').first()
Expected: visible
Received: hidden
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('text=Categories').first()
    12 × locator resolved to <span class="text-[9px] font-black uppercase tracking-wider mt-1 transition-all text-gray-400 dark:text-gray-500">Categories</span>
