...
- Name: admin-flow.spec.ts >> Admin Console Automation Suite >> should successfully load Admin Dashboard with real-time operations metrics
- Location: tests\e2e\admin-flow.spec.ts:13:7
...
Locator: locator('text=Operational Dashboard').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Operational Dashboard').first()
